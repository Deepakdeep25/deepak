	...
	<center>
		<form action="AddVendor" method="post">
			<table style=border:1px>
				...
				<td><input type="text" name="certificateIssuedDate" id="datepicker" required></td>
				</tr>

				<tr>
				<td>Certificate Validity Date</td><!-- date -->
				<td><input type="text" name="certificateValidityDate" id="datepicker1" required></td>
				</tr>
  
  				<tr>
				<td>Year of Establishment</td><!-- year -->
				<td><select name="yearOfEstablishment" required>
				...
				<td><input type="text" name="PaymentGateway" required></td>
				</tr>
